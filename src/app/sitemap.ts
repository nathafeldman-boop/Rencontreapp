...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/tinder`, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/bio-tinder`, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/hinge`, changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_URL}/bumble`, changeFrequency: "monthly", priority: 0.8 },
